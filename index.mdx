...
<CardGroup cols={3}>
  <Card title="Galactic VPC" icon="network-wired" href="/galactic-vpc/overview">
    Private IPv6 networks for your Compute Instances, spanning every location they run in.
  </Card>
  <Card title="ALB" icon="brain" href="/alb/overview">
  ...
  <Card title="Compute" icon="microchip" href="/compute/overview">
    Run container images and unikernels as isolated Instances close to your users.
  </Card>
