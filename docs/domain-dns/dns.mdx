...
2. Global Authoritative DNS – Datum serves authoritative DNS via a globally distributed anycast system for performance and redundancy. Any domain or subdomain can use Datum’s authoritative DNS by setting up the domain in Datum Cloud ([<u>cloud.datum.net</u>](http://cloud.datum.net) or via _datumctl_) and then adjusting your domain to point to Datum’s nameservers:
   - [<u>ns1.datumdomains.net</u>](http://ns1.datumdomains.net)
   - [<u>ns2.datumdomains.net</u>](http://ns2.datumdomains.net)
   - [<u>ns3.datumdomains.net</u>](http://ns3.datumdomains.net)
   - [<u>ns4.datumdomains.net</u>](http://ns4.datumdomains.net)
...
See <u>ALIAS (“CNAME flattening”)</u> for details.
