...
`datumctl` is the command-line tool for working with Datum Cloud. If you’ve used kubectl, you'll find a similar model including resources, commands, and a predictable structure. For both developer and agentic users, `datumctl` is the fastest and best way to interact with Datum.
