...
<Note>
  These are the **Envoy Gateway** extension resources in Datum Cloud networking. They build on the [Gateway API](/api/networking/gateway/overview) with implementation-specific policy for traffic behavior and security. For the broader picture, see the [Networking overview](/api/networking/overview).
</Note>
