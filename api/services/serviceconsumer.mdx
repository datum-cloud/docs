...
<Note>
  API resource reference for **ServiceConsumer**, part of the [Services service](/api/services/overview). To create or change one, see [Changing resources](/datumctl/resources/changing); to inspect, see [Reading resources](/datumctl/resources/reading).
</Note>
