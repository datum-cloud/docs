...
| Between Instances on the same network in different locations | Not guaranteed | A network spans locations, but Datum doesn't yet guarantee private connectivity between locations. Don't depend on it for production traffic. |
