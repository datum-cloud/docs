...
Generate the autocompletion script for datumctl for the specified shell.
...
* [datumctl completion bash](/datumctl/command/datumctl_completion_bash/)	 - Generate the autocompletion script for bash
* [datumctl completion fish](/datumctl/command/datumctl_completion_fish/)	 - Generate the autocompletion script for fish
* [datumctl completion powershell](/datumctl/command/datumctl_completion_powershell/)	 - Generate the autocompletion script for powershell
* [datumctl completion zsh](/datumctl/command/datumctl_completion_zsh/)	 - Generate the autocompletion script for zsh
