...
* [datumctl](/datumctl/cli-reference/)	 - A CLI for interacting with the Datum platform
* [datumctl apply edit-last-applied](/datumctl/command/datumctl_apply_edit-last-applied/)	 - Edit latest last-applied-configuration annotations of a resource/object
* [datumctl apply set-last-applied](/datumctl/command/datumctl_apply_set-last-applied/)	 - Set the last-applied-configuration annotation on a live object to match the contents of a file
* [datumctl apply view-last-applied](/datumctl/command/datumctl_apply_view-last-applied/)	 - View the latest last-applied-configuration annotations of a resource/object
