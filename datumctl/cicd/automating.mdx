...
<Info>
  On **GitHub Actions**, you rarely need to wire this up by hand. The [setup-datumctl-action](/datumctl/cicd/github-actions) installs the CLI and authenticates a service account in one step. This page is for every other pipeline, and for understanding what that action does under the hood.
</Info>
