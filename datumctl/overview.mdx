...
This section teaches you how to use `datumctl`; the [CLI Commands](/cli/options) reference lists every command and flag. New here? The [Quickstart](/datumctl/quickstart) takes you from install to your first command.
...
Also useful: [Output formats & scripting](/datumctl/output-and-scripting), [Discovering resources & schemas](/datumctl/discovering-resources), and — for existing kubectl users — [using datumctl with kubectl](/datumctl/kubectl-interop).
