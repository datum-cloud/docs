...
|---|---|---|
| [Application Load Balancer](/agents/skills/alb) | Load balancers, hostnames, routes and origins, WAF, auth | HTTPProxy, Domain, TrafficProtectionPolicy, SecurityPolicy, BackendTrafficPolicy |
