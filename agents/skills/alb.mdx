...
Until the plugin is published to the Datum catalog, install a release archive with `datumctl plugin install datum-cloud/network-services-operator@<tag>`. Check it with `datumctl alb version`.
</Warning>
