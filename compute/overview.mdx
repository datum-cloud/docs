...
For each location in a placement, Datum starts the requested number of Instances there. Every Instance attaches to a [network](/galactic-vpc/networks) in your project and receives a private IPv6 address. To reach a workload from the internet, you publish it on a Datum-managed HTTPS URL.
