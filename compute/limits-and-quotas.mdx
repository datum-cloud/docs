...
For more information about networking, see [Networks](/galactic-vpc/networks#limitations). To learn which networking capabilities Datum is working on, see [Planned capabilities](/galactic-vpc/networks#planned-capabilities).
