---
title: "datumctl docs generate-cli-docs"
sidebar:
  hidden: true
---
...
```
datumctl docs generate-cli-docs [flags]
```
...
```
  -h, --help                help for generate-cli-docs
      --output-dir string   Directory to use to output the generated documentation (default "/tmp/datumctl-generated-doc")
```
